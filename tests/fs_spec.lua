...
describe("fs", function()
  it("can get the directory path from the file path", function()
    ...
    assert.equals(expected_simple_dirpath, fs.get_dir_path_from_filepath(simple_filepath))
    ...
    assert.equals(expected_full_dirpath, fs.get_dir_path_from_filepath(full_filepath))
    ...
    assert.equals(expected_no_ext_dirpath, fs.get_dir_path_from_filepath(no_ext_filepath))
    ...
    assert.equals(expected_space_in_dirpath, fs.get_dir_path_from_filepath(space_in_path))
  end)
  ...
  it("can extract the filename from a file path", function()
    ...
    assert.equals(expected_simple_filename, fs.get_filename_from_filepath(simple_filepath))

    local full_filepath = "path" .. path_separator .. "to" .. path_separator .. "file.txt"
    local expected_full_filename = "file.txt"
    assert.equals(expected_full_filename, fs.get_filename_from_filepath(full_filepath))
    ...
    assert.equals(expected_nested_filename, fs.get_filename_from_filepath(nested_filepath))

    local no_ext_filepath = "path" .. path_separator .. "to" .. path_separator .. "file"
    local expected_no_ext_filename = "file"
    assert.equals(expected_no_ext_filename, fs.get_filename_from_filepath(no_ext_filepath))

    local space_in_filename = "path" .. path_separator .. "to" .. path_separator .. "my file.txt"
    local expected_space_in_filename = "my file.txt"
    assert.equals(expected_space_in_filename, fs.get_filename_from_filepath(space_in_filename))
  end)
  ...
  it("can add a file extension to a filename", function()
    ...
    assert.equals("file.png", fs.add_file_ext("file.hello.world", "png"))
  ...
  it("can add a file extension to a filepath", function()
    ...
    assert.equals(expected_filepath_no_ext, fs.add_file_ext(filepath_no_ext, "png"))
    ...
    assert.equals(expected_filepath_with_ext, fs.add_file_ext(filepath_with_ext, "png"))
    ...
    assert.equals(expected_nested_dir_filepath, fs.add_file_ext(nested_dir_filepath, "png"))
    ...
    assert.equals(expected_dot_in_dir_filepath, fs.add_file_ext(dot_in_dir_filepath, "png"))
    ...
    assert.equals(expected_filepath_with_space, fs.add_file_ext(filepath_with_space, "png"))
  end)
end)
